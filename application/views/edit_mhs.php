					...
					<div class="col-md-8">
						<div class="card" style="border-style: double; margin-top: 1%; margin-bottom: 3%; margin-right: 2%; margin-left: 2%">
							<div class="card-text" align="center" style="margin-right: 2%; margin-left: 2%; margin-top: 3%">
								<?php foreach($data_mhs as $a){ ?>
                                        <h5 class="card-title"></h5>
                                        <div align="center" class="mb-5" style="margin-top:1%">
                                            <font size= "5" style="font-family: Bahnschrift Condensed; font-weight: bold; color: #b30000; text-decoration: underline;">Edit Data Mahasiswa <?php echo $a->nama ?></font>
                                        </div>
                                        <hr/>
                                        <form action="<?php echo base_url().'page/update_mhs'; ?>" method="post">
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
                                                    <input id="nim" name="nim" placeholder="NIM" type="text" required value="<?php echo $a->nim ?>" class="form-control here">

                                                    <input id="nim_lama" name="nim_lama" type="hidden" required value="<?php echo $a->nim ?>" class="form-control here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
