					...
					<div class="col-md-8">
						<div class="card" style="border-style: double; margin-top: 1%; margin-bottom: 3%; margin-right: 2%; margin-left: 2%">
							<div class="card-text" align="center" style="margin-right: 2%; margin-left: 2%; margin-top: 3%">
								<?php foreach($info_kt as $a){ ?>
                                        <h5 class="card-title"></h5>
                                        <div align="center" class="mb-5" style="margin-top:1%">
                                            <font size= "5" style="font-family: Bahnschrift Condensed; font-weight: bold; color: #b30000; text-decoration: underline;">Edit Data Kuliah Tamu <?php echo $a->kuliah ?></font>
                                        </div>
                                        <hr/>
                                        <form action="<?php echo base_url().'page/update_kt'; ?>" method="post">
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
                                                    <input id="kuliah" name="kuliah" placeholder="NAMA KULIAH TAMU" type="text" required value="<?php echo $a->kuliah ?>" class="form-control here">

                                                    <input id="id_info_kt" name="id_info_kt" type="hidden" required value="<?php echo $a->id_info_kt ?>" class="form-control here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
                                                    <input id="waktu" name="waktu" placeholder="WAKTU" type="date" value="<?php echo $a->waktu ?>" required class="form-control here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
                                                    <input id="tempat" name="tempat" placeholder="TEMPAT" type="text" value="<?php echo $a->tempat ?>" required class="form-control here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-2 col-8" align="center">
